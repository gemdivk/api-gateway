...
const file_proto_order_proto_rawDesc = "" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status2\xeb\x02\n" +
	"\fOrderService\x12>\n" +
	"\vCreateOrder\x12\x19.order.CreateOrderRequest\x1a\x14.order.OrderResponse\x12@\n" +
	"\fGetOrderByID\x12\x1a.order.GetOrderByIDRequest\x1a\x14.order.OrderResponse\x12A\n" +
	"\n" +
	"ListOrders\x12\x18.order.ListOrdersRequest\x1a\x19.order.ListOrdersResponse\x12P\n" +
	"\x11UpdateOrderStatus\x12\x1f.order.UpdateOrderStatusRequest\x1a\x1a.order.OrderStatusResponse\x12D\n" +
	"\vDeleteOrder\x12\x19.order.DeleteOrderRequest\x1a\x1a.order.DeleteOrderResponseB\x1dZ\x1border-service/proto;orderpbb\x06proto3"
...
var file_proto_order_proto_goTypes = []any{
	...
	(*OrderStatusResponse)(nil),      // 8: order.OrderStatusResponse
...
var file_proto_order_proto_depIdxs = []int32{
	...
	8,  // 12: order.OrderService.UpdateOrderStatus:output_type -> order.OrderStatusResponse
